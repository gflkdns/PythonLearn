...
'''
make.py -v [versionName] -n [releaseNote] -r [outPath]
'''
# 脚本配置
...
# 固定的文件路径
assetsPath = "./luomilib/src/main/assets/gg.one"  # assets下的dex文件名称
...
def makeAar():
    ...
    shutil.copy(dexPath, assetsPath)
...
def parseArg():
    global releaseNote, versions, root, dexPath, aarPath, logFilePath
